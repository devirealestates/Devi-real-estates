...
const Rent = () => {
  ...
  const propertyTypes = ['all', 'Flat for Rent', 'House for Rent', 'Villa', 'Apartment', 'PG/Hostel'];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[45vh] min-h-[350px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <p className="text-gray-300 text-sm mb-4">Home / Rent Property</p>
          <h1 
              ...
              <div className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-lg bg-white min-w-[180px]">
                ...
                <Select value={priceRange} onValueChange={setPriceRange}>
                  ...
                  <SelectContent className="bg-white border border-gray-200 rounded-xl shadow-lg z-[200]">
                    ...
                    <SelectItem value="0-10000">Under ₹10,000/mo</SelectItem>
                    <SelectItem value="10000-25000">₹10,000 - ₹25,000/mo</SelectItem>
                    <SelectItem value="25000-50000">₹25,000 - ₹50,000/mo</SelectItem>
                    <SelectItem value="50000+">Above ₹50,000/mo</SelectItem>
                  </SelectContent>
                </Select>
              </div>
                ...
                >
                  ...
                  <div className="aspect-[4/3] rounded-xl overflow-hidden mb-4">
                    <img 
                      ...
                      onError={(e) => {
                        e.currentTarget.src = 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=600';
                      }}
                    />
                  </div>
