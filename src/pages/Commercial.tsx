...
const Commercial = () => {
  ...
  const fetchProperties = async () => {
    try {
      ...
      const commercialProperties = propertiesData.filter(property => 
        ...
        property.type?.toLowerCase().includes('warehouse')
      );
  ...
  const propertyTypes = ['all', 'Office Space', 'Retail Shop', 'Warehouse', 'Commercial Land'];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[45vh] min-h-[350px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <p className="text-gray-300 text-sm mb-4">Home / Commercial</p>
          <h1 
              ...
              <div className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-lg bg-white min-w-[180px]">
                ...
                <Select value={priceRange} onValueChange={setPriceRange}>
                  ...
                  <SelectContent className="bg-white border border-gray-200 rounded-xl shadow-lg z-[200]">
                    ...
                    <SelectItem value="0-500000">Under ₹5,00,000</SelectItem>
                    ...
                    <SelectItem value="5000000+">Above ₹50,00,000</SelectItem>
                  </SelectContent>
                </Select>
              </div>
                ...
                >
                  ...
                  <div className="aspect-[4/3] rounded-xl overflow-hidden mb-4">
                    <img 
                      ...
                      onError={(e) => {
                        e.currentTarget.src = 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=600';
                      }}
                    />
                  </div>
