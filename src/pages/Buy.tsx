...
const Buy = () => {
  ...
  const propertyTypes = ['all', 'Apartments', 'House', 'Villa', 'Land', 'Flat'];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[45vh] min-h-[350px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <p className="text-gray-300 text-sm mb-4">Home / Properties</p>
          <h1 
                ...
                <Select value={priceRange} onValueChange={setPriceRange}>
                  <SelectTrigger className="border-0 p-0 h-auto shadow-none focus:ring-0">
                    <div className="flex flex-col items-start">
                      ...
                      <SelectValue placeholder="$50,000 - $1,25,000" />
                    </div>
                  </SelectTrigger>
                  <SelectContent className="bg-white border border-gray-200 rounded-xl shadow-lg z-[200]">
                ...
                >
                  ...
                  <div className="aspect-[4/3] rounded-xl overflow-hidden mb-4">
                    <img 
                      ...
                      onError={(e) => {
                        e.currentTarget.src = 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=600';
                      }}
                    />
                  </div>
