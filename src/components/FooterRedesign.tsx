          ...
          <div>
            ...
            <div className="flex gap-3 mb-5">
              <a 
                ...
                className="w-9 h-9 border border-gray-300 rounded-md flex items-center justify-center hover:border-orange-500 hover:text-orange-500 transition-colors text-gray-600"
                aria-label="Facebook"
              >
            ...
            <ul className="space-y-3">
              <li>
                <a 
                  ...
                  className="text-gray-500 text-sm hover:text-orange-500 transition-colors inline-block"
                  title="Call us"
                >
                  +91 99129 91671
                </a>
              ...
              <li>
                <a 
                  ...
                  title="Send email"
                >
                  info.devirealestates@gmail.com
                </a>
              </li>
              <li>
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-gray-500 text-sm leading-relaxed hover:text-orange-500 transition-colors block"
